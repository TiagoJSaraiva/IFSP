...
-- Nome do aluno: Tiago Jarruge Saraiva
...
select max(ValorUnitario) as 'Valor do produto mais caro',
	   min(ValorUnitario) as 'Valor do produto mais barato'  
from PRODUTOS;
go
...
select avg(Salario) as 'Média Salarial' from VENDEDORES;
go
